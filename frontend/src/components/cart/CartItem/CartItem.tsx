      ...
      <div className="cart-item-details">
        ...
        {item.variantInfo && (
          <div className="cart-item-variant">
            ...
            {item.variantInfo.storage && (
              <span className="cart-item-variant-badge">{item.variantInfo.storage}</span>
            )}
            {item.variantInfo.processor && (
              <span className="cart-item-variant-badge">{item.variantInfo.processor}</span>
            )}
            {item.variantInfo.color && (
              <span className="cart-item-variant-badge">{item.variantInfo.color}</span>
            )}
            {item.variantInfo.connectivity && (
              <span className="cart-item-variant-badge">{item.variantInfo.connectivity}</span>
            )}
          </div>
        )}
      </div>
