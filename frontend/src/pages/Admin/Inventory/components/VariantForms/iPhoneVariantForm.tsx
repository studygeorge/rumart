...
const MEMORY_OPTIONS = ['128 ГБ', '256 ГБ', '512 ГБ', '1 ТБ', '2 ТБ']
const CONNECTIVITY_OPTIONS = ['SIM + eSIM', 'eSIM', 'Dual SIM']
...
const iPhoneVariantForm: React.FC<iPhoneVariantFormProps> = ({
  ...
  const memoryOrder = { '128 ГБ': 1, '256 ГБ': 2, '512 ГБ': 3, '1 ТБ': 4 , '2 ТБ': 5}
  ...
  const copyVariant = (index: number) => {
    ...
    const copiedVariant: iPhoneVariant = {
      ...variantToCopy,
      id: undefined,
      sku: variantToCopy.sku,          // ✅ БЕЗ "-COPY"
